...
assert(subsets.includes('data-workspace-tab="editorial"'), 'Editorial tab missing');
assert(/data-workspace-panel="editorial"\s+hidden/.test(subsets), 'Editorial must remain hidden until selected');
assert(subsets.includes('Optimal Java solution'), 'Original editorial content missing');
